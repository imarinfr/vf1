...
#' @details
#' \itemize{
#'   \item\code{generatenvPointwise} generates pointwise normative values
#'   \item\code{generatenvSmoothed} generates smoothed normative values
#' }
...
#' are provided in the package. The first one, \code{generatenvPointwise},
#' genearates normative values directly from pointwise statistics. The second one,
#' \code{generatenvSmooth}, uses 2D quadratic functions to smooth out those
#' pointwise statistics. Variations or improvements can be regenerated by copying
#' the code in those functions and editing it.
#' \itemize{
